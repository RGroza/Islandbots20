...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(10, 0, .5);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(4.5, .1, .1);

    public static double LATERAL_MULTIPLIER = 1.071;
